...
Read `.claude/current-plan.md` to get:
...
If `current-plan.md` doesn't exist, tell the user to run `/openspec-autodev:auto-dev $ARGUMENTS` first (at least through Phase 2).
